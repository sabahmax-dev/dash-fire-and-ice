...
IL_0022:
	{
		int32_t L_6 = V_0;
		if ((((int32_t)L_6) == ((int32_t)((int32_t)52))))
		{
			goto IL_0029;
		}
	}
...
IL_0020:
	{
		...
		bool L_6 = ((InputField_tABEA115F23FBD374EBE80D4FAC1D15BD6E37A140_StaticFields*)il2cpp_codegen_static_fields_for(InputField_tABEA115F23FBD374EBE80D4FAC1D15BD6E37A140_il2cpp_TypeInfo_var))->___s_IsQuestDevice;
		V_3 = L_6;
		bool L_7 = V_3;
		if (!L_7)
		{
...
IL_003e:
	{
		bool L_10;
		L_10 = TouchScreenKeyboard_get_isInPlaceEditingAllowed_mE57CDF32437DD1DCDC665072457C91DD31EB93D0(NULL);
...
IL_004a:
	{
		bool L_11;
		L_11 = TouchScreenKeyboard_get_isSupported_mCFAC95CA6CAA06B4E21F42E3C40A39668D6B438E(NULL);
		V_4 = L_11;
		goto IL_0053;
	}
...
IL_03be:
	...
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_115 = __this->___m_Keyboard;
		NullCheck(L_115);
		int32_t L_116;
		L_116 = TouchScreenKeyboard_get_status_mCC466FDEC7E1913D8585ABA7F048FC198CB19504(L_115, NULL);
		G_B84_0 = ((!(((uint32_t)L_116) <= ((uint32_t)0)))? 1 : 0);
		goto IL_03d7;
	}
...
IL_03d7:
	...
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_118 = __this->___m_Keyboard;
		NullCheck(L_118);
		int32_t L_119;
		L_119 = TouchScreenKeyboard_get_status_mCC466FDEC7E1913D8585ABA7F048FC198CB19504(L_118, NULL);
		V_29 = (bool)((((int32_t)L_119) == ((int32_t)2))? 1 : 0);
		bool L_120 = V_29;
		if (!L_120)
		{
			goto IL_03fb;
...
IL_03fb:
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_121 = __this->___m_Keyboard;
		NullCheck(L_121);
		int32_t L_122;
		L_122 = TouchScreenKeyboard_get_status_mCC466FDEC7E1913D8585ABA7F048FC198CB19504(L_121, NULL);
		V_30 = (bool)((((int32_t)L_122) == ((int32_t)1))? 1 : 0);
		bool L_123 = V_30;
		if (!L_123)
		{
			goto IL_0416;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CanvasScaler_HandleScaleWithScreenSize_m3F436166B074013EDBEE38B7009C338650CF942C (CanvasScaler_t3BC095205EAD308CF3EAC27136A73387AC32FC3B* __this, const RuntimeMethod* method) 
{
	...
	float V_4 = 0.0f;
	bool V_5 = false;
	Display_t06A3B0F5169CA3C02A4D5171F27499A23D3581D1* V_6 = NULL;
	int32_t V_7 = 0;
	int32_t V_8 = 0;
	bool V_9 = false;
	bool V_10 = false;
...
IL_002a:
	...
	}
	{
		...
		V_6 = L_11;
		Display_t06A3B0F5169CA3C02A4D5171F27499A23D3581D1* L_12 = V_6;
		NullCheck(L_12);
		int32_t L_13;
		L_13 = Display_get_renderingWidth_mD23656E7A8270AF79B0EF4124959B3E18BEDF0C7(L_12, NULL);
		Display_t06A3B0F5169CA3C02A4D5171F27499A23D3581D1* L_14 = V_6;
		NullCheck(L_14);
		int32_t L_15;
...
IL_0052:
	{
		...
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_18 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___m_ReferenceResolution);
		float L_19 = L_18->___x;
		V_3 = ((float)(L_17/L_19));
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_20 = V_0;
		float L_21 = L_20.___y;
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_22 = (Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(&__this->___m_ReferenceResolution);
		float L_23 = L_22->___y;
		V_4 = ((float)(L_21/L_23));
		int32_t L_24 = __this->___m_ScreenMatchMode;
		V_8 = L_24;
		int32_t L_25 = V_8;
		V_7 = L_25;
		int32_t L_26 = V_7;
...
IL_00a3:
	{
		float L_27 = __this->___m_MatchWidthOrHeight;
...
IL_00bd:
	{
		float L_30 = __this->___m_MatchWidthOrHeight;
...
IL_00d7:
	{
		float L_33 = V_3;
		float L_34;
		L_34 = Mathf_Log_m116F062EEBF1C53EC8D18C9B1748E999EF9424EF_inline(L_33, (2.0f), NULL);
		float L_35 = V_4;
		float L_36;
		L_36 = Mathf_Log_m116F062EEBF1C53EC8D18C9B1748E999EF9424EF_inline(L_35, (2.0f), NULL);
		float L_37 = __this->___m_MatchWidthOrHeight;
		float L_38;
...
IL_0124:
	{
		float L_47 = V_2;
		CanvasScaler_SetScaleFactor_m195FFD8019696523653CA6CB1B8531ECE4020636(__this, L_47, NULL);
		float L_48 = __this->___m_ReferencePixelsPerUnit;
		CanvasScaler_SetReferencePixelsPerUnit_m77B9E51B468EC9750355687AA6E25564D60BE9B5(__this, L_48, NULL);
		return;
	}
}
