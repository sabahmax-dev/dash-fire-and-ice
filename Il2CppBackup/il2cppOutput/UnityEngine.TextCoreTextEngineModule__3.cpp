...
IL_004f:
	{
		...
		NullCheck(L_12);
		int32_t L_13 = L_12->___characterCount;
		V_8 = (bool)((((int32_t)((((int32_t)L_11) < ((int32_t)L_13))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_14 = V_8;
		if (!L_14)
		{
			goto IL_0075;
...
IL_0075:
	{
		...
		if (((int32_t)(((((int32_t)((((int32_t)L_28) < ((int32_t)((int32_t)il2cpp_codegen_subtract(L_30, 1))))? 1 : 0)) == ((int32_t)0))? 1 : 0)|(int32_t)L_31)))
		{
			goto IL_00bd;
		}
	}
...
IL_00c3:
	...
	}
	{
		...
		NullCheck(L_39);
		TextElementInfoU5BU5D_tEC28C9B72883EE21AA798913497C69E179A15C4E* L_40 = L_39->___textElementInfo;
		...
		G_B13_0 = ((((int32_t)L_42) == ((int32_t)((int32_t)13)))? 1 : 0);
		goto IL_00f2;
	}
...
IL_00f2:
	...
	}
	{
		...
		NullCheck(L_44);
		TextElementInfoU5BU5D_tEC28C9B72883EE21AA798913497C69E179A15C4E* L_45 = L_44->___textElementInfo;
		int32_t L_46 = ___0_index;
		NullCheck(L_45);
		float L_47 = ((L_45)->GetAddressAt(static_cast<il2cpp_array_size_t>(((int32_t)il2cpp_codegen_subtract(L_46, 1)))))->___origin;
		V_4 = L_47;
	}
...
IL_0112:
	...
	{
		float L_50 = V_4;
		LineInfo_t2BBD461B330C46ACA45596A8E72FEA4172F88CF5 L_51 = V_3;
		float L_52 = L_51.___descender;
...
IL_0125:
	{
		...
		Vector2__ctor_m9525B79969AFFE3254B303A40997A56DEEB6F548_inline((&L_58), L_54, ((float)il2cpp_codegen_subtract(L_55, L_57)), NULL);
		G_B18_0 = L_58;
		G_B18_1 = G_B17_0;
	}
...
IL_013a:
	{
		...
		L_59 = Vector2_op_Addition_m8136742CE6EE33BA4EB81C5F584678455917D2AE_inline(G_B18_1, G_B18_0, NULL);
		V_1 = L_59;
